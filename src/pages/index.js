...
const formPopupAddCard = new PopupWithForm(".popup_add", (data) => {
    ...
    api.sendingCard(data["title"], data["link"])
        ...
        .catch((err) => {
            console.log(
                err,
                "Error: новая карточка не отправлена на сервер (index)"
            );
...
const formPopupEditProfile = new PopupWithForm(".popup_profile", (userData) => {
    ...
    api.updateUserData(userData)
        ...
        .catch((err) => {
            console.log(
                err,
                "Error: новые данные о пользователе не отправлены на сервер (index)"
            );
...
const formPopupEditAvatar = new PopupWithForm(".popup_avatar", (data) => {
    ...
    api.updateUserAvatar(data)
        ...
        .catch((err) => {
            console.log(
                err,
                "Error: новый аватар пользователя не отправлен на сервер (index)"
            );
        ...
        (cardId) => {
            api.likeCard(cardId)
                ...
                .catch((err) => {
                    console.log(
                        err,
                        "Error: лайк не отправлен на сервер (index)"
                    );
                });
        },
        (cardId) => {
            api.unlikeCard(cardId)
                ...
                .catch((err) => {
                    console.log(
                        err,
                        "Error: лайк не отменен на сервере (index)"
                    );
                });
        },
        (card, cardId) => {
            formPopupDelete.open(card, cardId);
        }
    );
    ...
    (card, cardId) => {
        api.deleteCard(cardId)
            ...
            .catch((err) => {
                console.log(
                    err,
                    "Error: карточка не удалена с сервера (index)"
                );
            });
    }
);
...
avatarEditButton.addEventListener("click", () => {
    ...
    formValidatorPopupAvatar.resetValidation();
});
